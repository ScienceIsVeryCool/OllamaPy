...
* [ ] **Test AI Integration with *Invalid* `ai_settings.json`:**  Specifically test the AI's behavior when using an invalid or incomplete `ai_settings.json`.  This is critical for identifying robustness. (Related to: Validate and Test `ai_settings.json`)
