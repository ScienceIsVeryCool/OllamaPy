...
class OllamaClient:
    ...
    def count_prompt_tokens(self, prompt: str, system: Optional[str] = None, context: Optional[str] = None) -> int:
    ...
    def get_context_usage(self, model: str, prompt: str, system: Optional[str] = None, context: Optional[str] = None) -> Dict[str, Any]:
    ...
    def print_context_usage(self, model: str, prompt: str, system: Optional[str] = None, context: Optional[str] = None) -> None:
        ...
        print(f"{status} Context: {color}{usage['usage_percent']:.1f}%{reset} ({usage['used_tokens']}/{usage['available_tokens']} tokens, {usage['model']})")
        
        if usage['is_over_limit']:
            print(f"⚠️  Warning: Prompt exceeds recommended context limit!")
    
    def generate(self, model: str, prompt: str, system: Optional[str] = None, show_context: bool = True) -> str:
