...
pytestmark = pytest.mark.skipif(not FLASK_AVAILABLE, reason="Flask dependencies not available")
...
class TestSkillEditorAPI:
    ...
    def test_update_custom_skill_endpoint(self, app):
        ...
        updated_data["function_code"] = "def execute():\n    log('[UpdateTest] Updated')"
        
        response = app.put('/api/skills/update_test_skill',
                          json=updated_data,
                          content_type='application/json')
    ...
    def test_cannot_update_builtin_skill(self, app):
        ...
        response = app.put('/api/skills/fear',
                          json=skill_data,
                          content_type='application/json')
    ...
    def test_validate_skill_endpoint(self, app):
        ...
        response = app.post('/api/skills/validate',
                           json=valid_skill,
                           content_type='application/json')
    ...
    def test_test_skill_endpoint(self, app):
        ...
        response = app.post('/api/skills/test',
                           json=request_data,
                           content_type='application/json')
