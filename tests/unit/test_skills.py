...
""",
    ...
    def test_skill_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert registry2.skills["persistent_test"].description == "A persistent test skill"
    ...
    def test_skill_loading_error_handling(self, mock_print):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            error_calls = [call for call in mock_print.call_args_list if 'Error loading skill' in str(call)]
